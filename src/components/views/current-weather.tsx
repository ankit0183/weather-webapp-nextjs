...
const getWeatherIcon = (main: string) => {
  switch (main.toLowerCase()) {
    case 'clear':
      return (
        <Sunny className="w-32 h-32 text-yellow-500 animate-spin-slow" />
      );
    case 'clouds':
      return (
        <Cloudy className="w-32 h-32 text-gray-500 animate-float" />
      );
    case 'rain':
      return (
        <Rainy className="w-32 h-32 text-blue-500 animate-drip" />
      );
    default:
      return (
        <ClearSky className="w-32 h-32 text-yellow-400 animate-pulse-slow" />
      );
  }
};
